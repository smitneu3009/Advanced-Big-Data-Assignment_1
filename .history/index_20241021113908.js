...
const redisClient = require('./redisConnection');  // Renamed to clarify it's a Redis client
...
const CLIENT_ID = process.env.CLIENT_ID;  // Load CLIENT_ID from .env file
...
async function verifyToken(req, res, next) {
  ...
  try {
    ...
    req.user = payload; // User info is now accessible via req.user
    next();
  } catch (error) {
